...
hist(hpsubset$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")

## Copy to file .PNG
dev.copy(png,"./Project01/plot1.png", width=480, height=480)
dev.off()